...
public class produtoCadastro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        campoNome.setBackground(new java.awt.Color(0, 0, 102));
        ...
        campoValor.setBackground(new java.awt.Color(0, 0, 102));
        ...
        campoCategoria.setBackground(new java.awt.Color(0, 0, 102));
        ...
        campoCategoria1.setBackground(new java.awt.Color(0, 0, 102));
        campoCategoria1.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        campoCategoria1.setForeground(new java.awt.Color(255, 255, 255));
        campoCategoria1.setBorder(null);
        ...
        campoPeso.setBackground(new java.awt.Color(0, 0, 102));
        campoPeso.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(campoCategoria1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double v = Double.parseDouble(campoValor.getText());
        p.setValor(v);
        int c = Integer.parseInt(campoCategoria.getText());
        p.setCategoria(c);
       
        
        produtoDAO dao = new produtoDAO();
        status.setText(dao.inserir(p));
    ...
    produtoLista lista;
    public void setProdutoLista(produtoLista pl){
        lista = pl;
    }
    /**
