...
public class produtoLista extends javax.swing.JFrame {
    ...
    public void atualizaTabela(){
        ...
        for(produto p : produtos){
            ...
            tab.setValueAt(p.getCodigo(),i,0);
            tab.setValueAt(p.getNome(),i,1);
            tab.setValueAt(p.getValor(),i,2);
            tab.setValueAt(p.getCategoria(),i,3);
            tab.setValueAt(p.getPeso(),i,4);
            i++;
        }
    }
    /**
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Supermercado/Produto");
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CODIGO", "NOME", "VALOR", "CATEGORIA", "PESO"
            }
        ));
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        pc.setProdutoLista(this);
        pc.setVisible(true);
    }//GEN-LAST:event_btnCadastrarActionPerformed

    private void btnAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarActionPerformed
        int linha = tabela.getSelectedRow();
        int codigo = (int)tab.getValueAt(linha, 0);
        String nome = (String)tab.getValueAt(linha,1);
        double valor = (double) tab.getValueAt(linha,2);
        int categoria = (int)tab.getValueAt(linha, 3);
        double peso = (double) tab.getValueAt(linha,4);
        ...
        pa.preencherCampos(p);
        pa.setProdutoLista(this);
        pa.setVisible(true);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        int resposta = JOptionPane.showConfirmDialog(null, "Deseja realmente excluir o produto?");
        if(resposta == 0){
            int linha = tabela.getSelectedRow();
            int codigo = (int)tab.getValueAt(linha, 0);
            ...
            produtoDAO dao = new produtoDAO();
            JOptionPane.showMessageDialog(null, dao.excluir(p));
            atualizaTabela();
        }
